...
function Review() {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const response = await fetch("https://script.google.com/macros/s/AKfycbw5rVIyq9HqvA1zKM2K0QfA9FCZX8MTmyQum6v6kiwbhiNOIiNaWiqFH0_v23_eU5Qveg/exec", {
                method: "POST",
                mode: 'cors',
                headers: {
